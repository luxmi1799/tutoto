...
class _home_body extends State<home> {
  ...
  banner_list(BuildContext context) async{
    var theory_url = 'https://tutoro.co.in/mobile-authenticate/banners.php';
    var response = await http.post(Uri.parse(theory_url));
    Map mapRes = json.decode(response.body);
    print('Response from server: $mapRes');
    var bloglists = mapRes["commandResult"]["data"]["banner"];
    print("bloglists$bloglists");
    setState(() {
      imglist = bloglists;
    });
          ...
          child: Column(children: [
           ...
           /* Container(
            ...
            Padding(
              ...
              child:    imglist.length==0? Center(child: Text("Loading.....",style: TextStyle(
                fontSize: 22,
              ),),):Container(
                height: 240,
                  ...
                  itemBuilder: (context, i) =>
                    ClipRRect(
                      borderRadius: BorderRadius.circular(4),
                        child: Image.network(imglist[i]["Image"], fit: BoxFit.cover,)),
                 // ),
                ),
              ),
            ),
                          ...
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: SizedBox.fromSize(
                                ...
                                child:Image.network("${getdata[index]["Image"]}", fit: BoxFit.cover,height: 60,),
                              ),
                            ),
                          ),
                          SizedBox(
